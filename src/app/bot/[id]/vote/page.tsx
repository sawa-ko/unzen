    ...
    return (
        <div className="flex flex-col gap-3 items-center justify-center h-[70vh]">
            <div className="max-w-xl w-full flex justify-between items-center">
                ...
                <p className="text-red-500">You can vote tomorrow</p>
            </div>
            <Button as={Link} href={`/bot/${params.id}`} size="sm" startContent={<ArrowLeftIcon className="w-5 h-5" />}>Return to Probot</Button>
        </div>
    )
}