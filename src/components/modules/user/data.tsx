...
import type { GetUserQuery } from "@/lib/graphql/apollo";
import { Heading } from "@/components/ui/heading";
import Image from "@/components/ui/image";
import { Text } from "@/components/ui/text";
import { useGetUserSuspenseQuery } from "@/lib/graphql/apollo";
...
export default function UserData({ id }: Pick<GetUserQuery["getUser"], "id">) {
	const {
		data: { getUser },
		error,
