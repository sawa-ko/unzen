...
import { Card, CardBody, Modal, ModalBody, ModalContent, ModalHeader, Tooltip } from "@nextui-org/react";
                ...
                <ModalBody>
                    ...
                    <div className="py-2 flex flex-col gap-2">
                        <Tooltip showArrow content="Coming soon">
                            <Card shadow="none" className="bg-default-50 opacity-50 cursor-not-allowed">
                                <CardBody>
                        ...
                        <Card as={Link} href="/bot/add" shadow="none" className="bg-default-50" isPressable>
                            <CardBody>
                                <div className="flex gap-3 items-center">
